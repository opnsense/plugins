...
"$make_command" -C "$ports_directory/dns/bind-tools" PORTSDIR="$ports_directory" package
...
"$make_command" -C "$ports_directory/dns/bind920" PORTSDIR="$ports_directory" package

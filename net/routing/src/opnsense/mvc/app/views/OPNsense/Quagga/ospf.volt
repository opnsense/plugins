...
<thead>
            <tr>
                ...
                <th data-column-id="network" data-type="string" data-visible="true">{{ lang._('Network Address') }}</th>
                <th data-column-id="mask" data-type="string" data-visible="true">{{ lang._('Mask') }}</th>
